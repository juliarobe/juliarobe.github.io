...
layout: project
type: project
image: /main/img/GalPropsEvol_Imgs/gal14_R_vs_mu.png
...
<b style="font-size: 24px;">Absolute Magnitude Distribution: Observed vs V-max Corrected:</b>
...
<b style="font-size: 24px;"> Physical Size Distribution: Observed vs V-max Corrected:</b>
...
<b style="font-size: 24px;">Surface Brightness Distribution: Observed vs V-max Corrected:</b>
...
```
### Profile Fits:
<b style="font-size: 24px;">Galaxy 3 Profiles:</b>
<img class="img-fluid" src="../img/GalPropsEvol_Imgs/gal3_R_vs_mu.png" width="500">
...
<b style="font-size: 24px;">Galaxy 10 Profiles:</b>
<img class="img-fluid" src="../img/GalPropsEvol_Imgs/gal10_R_vs_mu.png" width="500">
...
<b style="font-size: 24px;">Galaxy 14 Profiles:</b>
<img class="img-fluid" src="../img/GalPropsEvol_Imgs/gal14_R_vs_mu.png" width="500">
...
<b style="font-size: 24px;">Sample A Concentration Index versus Redshift:</b>
<img class="img-fluid" src="../img/GalPropsEvol_Imgs/ci_vs_z_subplotsA.png" width="500">

<b style="font-size: 24px;">Sample B Concentration Index versus Redshift:</b>
<img class="img-fluid" src="../img/GalPropsEvol_Imgs/ci_vs_z_subplotsB.png" width="500">

<b style="font-size: 24px;">Sample A Scatterplot of Concentration Index versus Redshift:</b>
<img class="img-fluid" src="../img/GalPropsEvol_Imgs/ci_vs_z_single_scatterA.png" width="500">

<b style="font-size: 24px;">Sample B Scatterplot of Concentration Index versus Redshift:</b>
<img class="img-fluid" src="../img/GalPropsEvol_Imgs/ci_vs_z_single_scatterB.png" width="500">

<b style="font-size: 24px;">Median Concentration Index versus Redshift:</b>
...
<b style="font-size: 24px;">Median Radius vs Evolution Corrected Abs Magnitudes:</b>
<img class="img-fluid" src="../img/GalPropsEvol_Imgs/med_R_vs_evolcorr_Mr.png" width="500">

<b style="font-size: 24px;">Difference of Median Radius vs Evolution Corrected Abs Magnitude:</b>
